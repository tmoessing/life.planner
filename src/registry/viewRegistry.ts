...
const viewComponents: Record<ViewType, ComponentType> = {
  ...
  'planner': lazy(() => import('@/components/views/PlannerViewRefactored').then(m => ({ default: m.PlannerViewRefactored }))),
  'sprint-planning': lazy(() => import('@/components/views/SprintPlanningView').then(m => ({ default: m.SprintPlanningView }))),
  'add-stories': lazy(() => import('@/components/views/AddStoriesViewRefactored').then(m => ({ default: m.AddStoriesViewRefactored }))),
